...
<a href="<?=$_SERVER['PHP_SELF']?>?action=demo"><img  src="assets/learn.jpg"></a>
   ...
   <h4 class="subtitle">Code the Deal <a href=<?=$_SERVER['PHP_SELF']?>?action=list&file=Doc/Acme/>Acme - Company in a Box</a></h4><h4 class="subtitle">Privacy <a href=<?=$_SERVER['PHP_SELF']?>?action=list&file=Doc/me/medical_wallet/doc/>medical patient's document wallet</a></h4>
