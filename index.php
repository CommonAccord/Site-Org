...
if(! ($dir == 'Doc/')) {
	...
	echo "<body style='font-size: 250%;'> <h3><a href=$_SERVER[PHP_SELF]?action=list&file=$rootdir[dirname]/>$rootdir[dirname]</a><br></hr>";
}
echo "<u>$dir:</u><br><br>";
...
echo "<body style='font-size: 250%;'><a href=$_SERVER[PHP_SELF]?action=list&file=$rootdir[dirname]/>$rootdir[dirname]</a><br><br><br>
