...
2.3={d-}2.3{-d}
2.4(a)(v)={d-}2.4(a)(v){-d}
2.4(a)(vi)={d-}2.4(a)(vi){-d}
2.4(a)(vii)={d-}2.4(a)(vii){-d}
2.4(b)={d-}2.4(b){-d}
2.4={d-}2.4{-d}
2.5(a)={d-}2.5(a){-d}
2.5(c)={d-}2.5(c){-d}
...
3.20(d)={d-}3.20(d){-d}
3.20(e)={d-}3.20(e){-d}
3.22(a)(i)={d-}3.22(a)(i){-d}
3.22(a)(ii)={d-}3.22(a)(ii){-d}
3.22(a)(iii)={d-}3.22(a)(iii){-d}
3.22(a)(v)={d-}3.22(a)(v){-d}
3.22(a)(vi)={d-}3.22(a)(vi){-d}
3.22(a)(vii)={d-}3.22(a)(vii){-d}
3.22(a)={d-}3.22(a){-d}
3.22(c)(i)={d-}3.22(c)(i){-d}
3.22(c)={d-}3.22(c){-d}
3.22(d)={d-}3.22(d){-d}
3.22(e)={d-}3.22(e){-d}
3.22(h)={d-}3.22(h){-d}
...
9.4={d-}9.4{-d}
9.5(a)={d-}9.5(a){-d}
A.Notices={d-}A.Notices{-d}
aCond.5.1.Counsel={d-}aCond.5.1.Counsel{-d}
aCov.08.Fin.Report.Month.Content={d-}aCov.08.Fin.Report.Month.Content{-d}
aCov.08.Fin.Report.Month.Wait.Days={d-}aCov.08.Fin.Report.Month.Wait.Days{-d}
Acquired_Companies={d-}Acquired Companies{-d}
Acquired_Company={d-}Acquired Company{-d}
Adjoining_Property={d-}Adjoining Property{-d}
Adjustment_Amount={d-}Adjustment Amount{-d}
Agreement={d-}Agreement{-d}
Applicable_Contract={d-}Applicable Contract{-d}
Applicable_Contracts={d-}Applicable Contracts{-d}
aRep.015.1.Litig.Since.Year={d-}aRep.015.1.Litig.Since.Year{-d}
aRep.Books.Location={d-}aRep.Books.Location{-d}
aRep.Contract.1.1.Max.$={d-}aRep.Contract.1.1.Max.${-d}
aRep.Contract.1.112.Max.$={d-}aRep.Contract.1.112.Max.${-d}
aRep.Contract.1.15.Max.$={d-}aRep.Contract.1.15.Max.${-d}
aRep.Contract.1.18.Max.$={d-}aRep.Contract.1.18.Max.${-d}
aRep.Contract.1.2.Max.$={d-}aRep.Contract.1.2.Max.${-d}
aRep.Contract.1.4.Max.$={d-}aRep.Contract.1.4.Max.${-d}
aRep.CustomerAndSupplier.Customer.Large.#={d-}aRep.CustomerAndSupplier.Customer.Large.#{-d}
aRep.CustomerAndSupplier.Customer.Year.End.Day={d-}aRep.CustomerAndSupplier.Customer.Year.End.Day{-d}
aRep.CustomerAndSupplier.Customer.Years={d-}aRep.CustomerAndSupplier.Customer.Years{-d}
aRep.CustomerAndSupplier.Supplier.Large.#={d-}aRep.CustomerAndSupplier.Supplier.Large.#{-d}
aRep.EmpBenefit.1.4.LR.Threshold.$={d-}aRep.EmpBenefit.1.4.LR.Threshold.${-d}
aRep.Event.08.Release.Max.$={d-}aRep.Event.08.Release.Max.${-d}
aRep.Event.10.Cap.Exp.Max.$={d-}aRep.Event.10.Cap.Exp.Max.${-d}
aRep.Event.11.Loan.Max.$={d-}aRep.Event.11.Loan.Max.${-d}
aRep.Event.12.Note.Max.Each.$={d-}aRep.Event.12.Note.Max.Each.${-d}
aRep.Event.12.Note.Max.Total.$={d-}aRep.Event.12.Note.Max.Total.${-d}
aRep.Fiscal.Years.#={d-}aRep.Fiscal.Years.#{-d}
aRep.Insider.Related.Since.YMD={d-}aRep.Insider.Related.Since.YMD{-d}
aRep.Insurance.1.1.Ins.Cover.Since.Year={d-}aRep.Insurance.1.1.Ins.Cover.Since.Year{-d}
aRep.Insurance.3.2.Ins.Policy.Amt.$={d-}aRep.Insurance.3.2.Ins.Policy.Amt.${-d}
aRep.Insurance.3.Policy.Years={d-}aRep.Insurance.3.Policy.Years{-d}
aRep.Insurance.4.2.Ins.NoDeny.Since.Year={d-}aRep.Insurance.4.2.Ins.NoDeny.Since.Year{-d}
aRep.Insurance.6.WorkComp.Claim.Year={d-}aRep.Insurance.6.WorkComp.Claim.Year{-d}
aRep.Inventory.Time={d-}aRep.Inventory.Time{-d}
aRep.IP.2.2.Assign.Since.Year={d-}aRep.IP.2.2.Assign.Since.Year{-d}
aRep.Labor.2.2.Labor.Year={d-}aRep.Labor.2.2.Labor.Year{-d}
aRep.Labor.2.4.Labor.Year={d-}aRep.Labor.2.4.Labor.Year{-d}
aRep.Labor.2.6.Labor.Year={d-}aRep.Labor.2.6.Labor.Year{-d}
aRep.Labor.2.7.Labor.Year={d-}aRep.Labor.2.7.Labor.Year{-d}
aRep.Litig.1.3.Litig.MaxLoss.$={d-}aRep.Litig.1.3.Litig.MaxLoss.${-d}
aRep.Personnel.1.Emp.Accrue.AsOf.YMD={d-}aRep.Personnel.1.Emp.Accrue.AsOf.YMD{-d}
aRep.Personnel.1.Emp.Since.YMD={d-}aRep.Personnel.1.Emp.Since.YMD{-d}
aRep.Personnel.5.Emp.Term.Since.YDM={d-}aRep.Personnel.5.Emp.Term.Since.YDM{-d}
aRep.Tax.1.6.AcqCoTaxReturnSince={d-}aRep.Tax.1.6.AcqCoTaxReturnSince{-d}
aRep.Tax.2.1.TaxYearsClosed={d-}aRep.Tax.2.1.TaxYearsClosed{-d}
aRep.Tax.2.2.TaxAdjustSince.Year={d-}aRep.Tax.2.2.TaxAdjustSince.Year{-d}
aRep.Tax.2.2.TaxAuditSince.Year={d-}aRep.Tax.2.2.TaxAuditSince.Year{-d}
aRep.YMD={d-}aRep.YMD{-d}
B.Notices={d-}B.Notices{-d}
Balance_Sheet_Date={d-}Balance Sheet Date{-d}
bCond.6.1.Opinion={d-}bCond.6.1.Opinion{-d}
bCond.6.2.Estop.Certs.By={d-}bCond.6.2.Estop.Certs.By{-d}
Breach={d-}Breach{-d}
Breaches={d-}Breaches{-d}
bRep.Buyer={d-}bRep.Buyer{-d}
Business_Day={d-}Business Day{-d}
Business_Day_Jurisd={d-}Business Day Jurisd{-d}
Business_Days={d-}Business Days{-d}
Buyer's_Closing_Documents={d-}Buyer's Closing Documents{-d}
Buyer.Atty.Identity.Full={d-}Buyer.Atty.Identity.Full{-d}
Buyer={d-}Buyer{-d}
Buyer_Group={d-}Buyer Group{-d}
Buyer_Indemnified_Persons={d-}Buyer Indemnified Persons{-d}
Cap.Common.Auth.#={d-}Cap.Common.Auth.#{-d}
Cap.Common.Issued.#={d-}Cap.Common.Issued.#{-d}
Cap.Common.Par.$={d-}Cap.Common.Par.${-d}
cCov.2.1.1.OtherShare.Max.%={d-}cCov.2.1.1.OtherShare.Max.%{-d}
cCov.2.1.Years={d-}cCov.2.1.Years{-d}
Cleanup={d-}Cleanup{-d}
Closing={d-}Closing{-d}
Closing_Balance_Sheet={d-}Closing Balance Sheet{-d}
Closing_Date={d-}Closing Date{-d}
Closing_Date_Shareholders'_Equity={d-}Closing Date Shareholders' Equity{-d}
Closing_Payment={d-}Closing Payment{-d}
Co.Regist.State.the={d-}Co.Regist.State.the{-d}
COBRA={d-}COBRA{-d}
Code={d-}Code{-d}
Company={d-}Company{-d}
Confidential_Information={d-}Confidential Information{-d}
Consent={d-}Consent{-d}
Consents={d-}Consents{-d}
Contemplated_Transaction={d-}Contemplated Transaction{-d}
Contemplated_Transactions={d-}Contemplated Transactions{-d}
Contract={d-}Contract{-d}
Contracts={d-}Contracts{-d}
Copyrights={d-}Copyrights{-d}
Def.Usage.Sec={d-}Def.Usage.Sec{-d}
Disc.3.1={d-}Disc.3.1{-d}
Disclosure_Letter={d-}Disclosure Letter{-d}
Dispute.Court.Fed.Location={d-}Dispute.Court.Fed.Location{-d}
Dispute.Court.State.Location={d-}Dispute.Court.State.Location{-d}
Dispute.Law.State.the={d-}Dispute.Law.State.the{-d}
Employee_Plan={d-}Employee Plan{-d}
Encumbrance={d-}Encumbrance{-d}
Encumbrances={d-}Encumbrances{-d}
End_Date={d-}End Date{-d}
Environment={d-}Environment{-d}
Environmental,_Health,_and_Safety_Liability={d-}Environmental, Health, and Safety Liability{-d}
Environmental_Law={d-}Environmental Law{-d}
Environmental_Laws={d-}Environmental Laws{-d}
Equity_Securities={d-}Equity Securities{-d}
Equity_Security={d-}Equity Security{-d}
ERISA={d-}ERISA{-d}
Escrow_Agreement={d-}Escrow Agreement{-d}
Escrow_Funds={d-}Escrow Funds{-d}
Exchange_Act={d-}Exchange Act{-d}
Facilities={d-}Facilities{-d}
Family={d-}Family{-d}
Financial_Statements={d-}Financial Statements{-d}
FS.Audited.YMD={d-}FS.Audited.YMD{-d}
FS.Unaudited.Months.#={d-}FS.Unaudited.Months.#{-d}
FS.Unaudited.YMD={d-}FS.Unaudited.YMD{-d}
GAAP={d-}GAAP{-d}
Governmental_Authorization={d-}Governmental Authorization{-d}
Governmental_Authorizations={d-}Governmental Authorizations{-d}
Governmental_Body={d-}Governmental Body{-d}
Hazardous_Activity={d-}Hazardous Activity{-d}
Hazardous_Material={d-}Hazardous Material{-d}
HSR_Act={d-}HSR Act{-d}
Indemnified_Person={d-}Indemnified Person{-d}
Indemnified_Persons={d-}Indemnified Persons{-d}
Indemnifying_Person={d-}Indemnifying Person{-d}
Independent_Accountants={d-}Independent Accountants{-d}
Intellectual_Property_Assets={d-}Intellectual Property Assets{-d}
Interim_Balance_Sheet={d-}Interim Balance Sheet{-d}
Interim_Balance_Sheet_Date={d-}Interim Balance Sheet Date{-d}
Interim_Shareholders'_Equity={d-}Interim Shareholders' Equity{-d}
Invention_Disclosure={d-}Invention Disclosure{-d}
Invention_Disclosures={d-}Invention Disclosures{-d}
IPRR.6.1.Loss.Threshold.1={d-}IPRR.6.1.Loss.Threshold.1{-d}
IPRR.6.1.Loss.Threshold.2={d-}IPRR.6.1.Loss.Threshold.2{-d}
IPRR.6.2.Loss.Threshold.1={d-}IPRR.6.2.Loss.Threshold.1{-d}
IPRR.6.2.Loss.Threshold.2={d-}IPRR.6.2.Loss.Threshold.2{-d}
IRS={d-}IRS{-d}
Knowledge={d-}Knowledge{-d}
Knowledge_of_Sellers={d-}Knowledge of Sellers{-d}
Leased_Real_Property={d-}Leased Real Property{-d}
Legal_Requirement={d-}Legal Requirement{-d}
Legal_Requirements={d-}Legal Requirements{-d}
Loss={d-}Loss{-d}
Losses={d-}Losses{-d}
Major_Customer={d-}Major Customer{-d}
Major_Customers={d-}Major Customers{-d}
Major_Supplier={d-}Major Supplier{-d}
Major_Suppliers={d-}Major Suppliers{-d}
Mark={d-}Mark{-d}
Marks={d-}Marks{-d}
Material_Adverse_Change={d-}Material Adverse Change{-d}
Material_Consents={d-}Material Consents{-d}
Material_Interest={d-}Material Interest{-d}
Net_Names={d-}Net Names{-d}
Objection_Notice={d-}Objection Notice{-d}
Occupational_Safety_and_Health_Law={d-}Occupational Safety and Health Law{-d}
Order={d-}Order{-d}
Ordinary_Course_of_Business={d-}Ordinary Course of Business{-d}
Organizational_Document={d-}Organizational Document{-d}
Organizational_Documents={d-}Organizational Documents{-d}
Owned_Real_Property={d-}Owned Real Property{-d}
Owner={d-}Owner{-d}
Patent={d-}Patent{-d}
Patents={d-}Patents{-d}
Permitted_Encumbrances={d-}Permitted Encumbrances{-d}
Person={d-}Person{-d}
Persons={d-}Persons{-d}
Plan={d-}Plan{-d}
Proceeding={d-}Proceeding{-d}
Proceedings={d-}Proceedings{-d}
Promissory_Note={d-}Promissory Note{-d}
Promissory_Notes={d-}Promissory Notes{-d}
Purchase_Price={d-}Purchase Price{-d}
Real_Property={d-}Real Property{-d}
Record={d-}Record{-d}
Records={d-}Records{-d}
Related_Person={d-}Related Person{-d}
Related_Persons={d-}Related Persons{-d}
Release={d-}Release{-d}
Released={d-}Released{-d}
Representative={d-}Representative{-d}
Representatives={d-}Representatives{-d}
Sale.Adjust$.Calculate.Base.Dollars($)={d-}Sale.Adjust$.Calculate.Base.Dollars($){-d}
Sale.Close.Cond.Satis.Time={d-}Sale.Close.Cond.Satis.Time{-d}
Sale.Close.Time.cl={d-}Sale.Close.Time.cl{-d}
Sale.CloseOblig.Seller.EmpAgt.Persons={d-}Sale.CloseOblig.Seller.EmpAgt.Persons{-d}
Sale.Price.Close.Dollars($)={d-}Sale.Price.Close.Dollars($){-d}
Sale.Price.Escrow.Dollars($)={d-}Sale.Price.Escrow.Dollars($){-d}
Sale.Price.Total.Dollars($)={d-}Sale.Price.Total.Dollars($){-d}
Secretary={d-}Secretary{-d}
Securities_Act={d-}Securities Act{-d}
Seller(s)={d-}Seller(s){-d}
Seller={d-}Seller{-d}
Sellers'_Closing_Document={d-}Sellers' Closing Document{-d}
Sellers'_Closing_Documents={d-}Sellers' Closing Documents{-d}
Sellers'_Releases={d-}Sellers' Releases{-d}
Sellers'_Representative={d-}Sellers' Representative{-d}
Sellers={d-}Sellers{-d}
Shares={d-}Shares{-d}
Software={d-}Software{-d}
Subsidiaries={d-}Subsidiaries{-d}
Subsidiary={d-}Subsidiary{-d}
Subsidiary_of_the_Company={d-}Subsidiary of the Company{-d}
Tax={d-}Tax{-d}
Tax_Return={d-}Tax Return{-d}
Tax_Returns={d-}Tax Returns{-d}
Taxes={d-}Taxes{-d}
Term.1.4.Cond.Satis.YMD={d-}Term.1.4.Cond.Satis.YMD{-d}
the_Acquired_Companies=the {d-}Acquired Companies{-d}
the_Adjustment_Amount=the {d-}Adjustment Amount{-d}
the_Closing=the {d-}Closing{-d}
The_Closing=the {d-}Closing{-d}
the_Closing_Balance_Sheet=the {d-}Closing Balance Sheet{-d}
The_Closing_Balance_Sheet=the {d-}Closing Balance Sheet{-d}
the_Closing_Date=the {d-}Closing Date{-d}
the_Closing_Date_Balance_Sheet=the {d-}Closing Date Balance Sheet{-d}
the_Closing_Date_Shareholders'_Equity=the {d-}Closing Date Shareholders' Equity{-d}
the_Closing_Payment=the {d-}Closing Payment{-d}
the_Code=the {d-}Code{-d}
the_Company=the {d-}Company{-d}
the_Company_and_its_Subsidiaries=the {d-}Company and its Subsidiaries{-d}
the_Disclosure_Letter=the {d-}Disclosure Letter{-d}
the_Escrow_Agent=the {d-}Escrow Agent{-d}
the_Escrow_Agreement=the {d-}Escrow Agreement{-d}
the_Facilities=the {d-}Facilities{-d}
the_Independent_Accountants=the {d-}Independent Accountants{-d}
the_Interim_Balance_Sheet=the {d-}Interim Balance Sheet{-d}
the_Secretary_of_State=the {d-}Secretary of State{-d}
the_Shares=the {d-}Shares{-d}
Third-Party_Claim={d-}Third-Party Claim{-d}
Third_Party={d-}Third Party{-d}
this_Agreement={d-}this Agreement{-d}
This_Agreement={d-}This Agreement{-d}
Threat_of_Release={d-}Threat of Release{-d}
Trade_Secrets={d-}Trade Secrets{-d}
