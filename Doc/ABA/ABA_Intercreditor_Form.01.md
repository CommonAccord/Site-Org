...
B.1.1.Ti=SENIORITY OF LIENS SECURING FIRST LIEN OBLIGATIONS
...
x1.sec=an Interest Rate Protection Agreement, or

x2.sec=a foreign exchange contract, currency swap agreement, futures contract, option contract, synthetic cap, or other similar agreement or arrangement, each of which is for the purpose of hedging the foreign currency risk associated with the operations of any Grantor,
...
x1.sec=a voluntary or involuntary case or proceeding under the Bankruptcy Code with respect to a Grantor,

x2.sec=any other voluntary or involuntary insolvency, reorganization, or bankruptcy case or proceeding, or any receivership, liquidation, reorganization, or other similar case or proceeding with respect to a Grantor or a material portion of its property,

x3.sec=a liquidation, dissolution, reorganization, or winding up of a Grantor, whether voluntary or involuntary and whether or not involving insolvency or bankruptcy, or

x4.sec=an assignment for the benefit of creditors or other marshaling of assets and liabilities of a Grantor.
...
x1.sec=modification by amendment, supplement, termination, or replacement of the document or obligation,

x2.sec=any waiver of a provision (including waivers by course of conduct), and

x3.sec=the settlement or release of any claim, whether oral or written, and regardless of whether the modification is in conformity with the provisions of the document or obligation governing modifications.
