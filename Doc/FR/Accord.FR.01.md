Intro.P1.sec={P1.N,E,A}, représenté par son {P1.Sign.Title}, {P1.Sign.Name.Full}, ( « {P1.Handle} » )

Intro.P2.sec={P2.N,E,A}, représenté par son {P2.Sign.Title}, {P2.Sign.Name.Full}, ( « {P2.Handle} » )

Intro.P3.sec={P3.N,E,A}, représenté par son {P3.Sign.Title}, {P3.Sign.Name.Full}, ( « {P3.Handle} » )

Intro.P4.sec={P4.N,E,A}, représenté par son {P4.Sign.Title}, {P4.Sign.Name.Full}, ( « {P4.Handle} » )

Intro.P5.sec={P5.N,E,A}, représenté par son {P5.Sign.Title}, {P5.Sign.Name.Full}, ( « {P5.Handle} » )

Intro.P6.sec={P6.N,E,A}, représenté par son {P6.Sign.Title}, {P6.Sign.Name.Full}, ( « {P6.Handle} » )
...
Intro.YMD.sec=DATE EFFECTIVE: {Agt.Sign.Date} (la « {Date_Effective} »)
...
Date_Effective={d-}date de l'{Accord}{-m}

Partie_Tierce_Identifiée={d-}Partie Tierce Identifiée{-m}

Parties_Tierce_Identifiées={d-}Parties Tierce Identifiées{-m}
