Heading={CompanyName}<br>CONVERTIBLE PROMISSORY NOTE PURCHASE AGREEMENT
...
3.6.Ti=Compliance with Other Instruments
...
4.4.Ti=Further Limitations on Disposition
