...
3.Ti=No Open Source Code

3.sec=However, in no event will {P2.the} incorporate into the {Work_Product} any software code licensed under the GNU GPL or LGPL or any similar “open source” license.

4.Ti=Right to License {Preexisting_IP}

4.sec={P2.The} represents and warrants that {P2.the} has an unqualified right to license to {P1.the} all {Preexisting_IP} as provided in this section.
