...
Agt.ByRepresented.Sec=BY AND BETWEEN: <ul><li>{P1.Name.Full} as {P1.Handle}<br>Represented by: {P1.Sign.Name.Full}; and<li> {P2.Name.Full} as {P2.Handle}<br>Represented by: {P1.Sign.Name.Full}</ul>
