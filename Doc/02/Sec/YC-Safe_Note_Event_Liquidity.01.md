...
MFN.1.2.cl=the fair market value of the {Common_Stock} at the time of the {Liquidity_Event} (determined by reference to the purchase price payable in connection with such {Liquidity_Event}) (the “{Liquidity_Price}&rdquo;)
