...
1.1.Sec=“{P1.Handle}&rdquo;: {P1.N,E,A}

1.2.Sec=“{P2.Handle}&rdquo;: {P2.N,E,A}
...
2.1.sec=Whereas {P2.the} owns all right, title, and interest in and to the U.S. patent applications listed in Schedule C-1 (the “{Patent_Applications}&rdquo;); and
