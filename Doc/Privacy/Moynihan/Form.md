...
4.1.0.Sec=Company may disclose non-personally identifiable aggregated user data, such as aggregated gender, age, height, weight, and usage data gathered from Company devices (without the inclusion of a user's name or other identifying information) to:

4.1.1.Sec=Organizations approved by Company that conduct consumer research into health and wellness;

4.1.2.Sec=Users of the Service for purposes of comparison of their personal health and wellness situation relative to the broader community; and

4.1.3.Sec=Advertisers and other third parties for their marketing and promotional purposes.


4.Sec=<b>{4.Ti}</b><br>{4.1.0.Sec}<ol><li>{4.1.1.Sec}<li>{4.1.2.Sec}<li>{4.1.3.Sec}</ol>
