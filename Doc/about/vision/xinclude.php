...
<td><a href=<?=$_SERVER['PHP_SELF']?>?action=list&file=core/form/>form</a></td><td>Forms are legal documents and their components.  Contracts, permits, pleadings.  Text that describes relationships and transactions.</td>
</tr>
...
<tr>
<td><img src="http://www.lakelocal.org/forms/PublishingImages/forms-icon.jpg"height="50px"></td>
<td><a href=<?=$_SERVER['PHP_SELF']?>?action=list&file=event/>event</a></td>
